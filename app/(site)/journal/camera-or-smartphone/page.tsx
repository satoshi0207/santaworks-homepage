          ...
          <section className="blk">
            ...
            <div className="note rv">
              ...
              <p>
                ...
                {/* ⚠️ 題名は「9割売れなくなって」なので、この注記とそのままでは食い違う。
                    題名を変えると記事のいちばん強い一行が弱くなるので、
                    **題名の側の緩さを、ここで自分から認める**形にしている。 */}
                <b>題名の「売れなくなって」も、正確には「出荷されなくなって」です。</b>
                短く言い切るために日常の言葉を選びましたが、この表が数えているのは出荷までです。
