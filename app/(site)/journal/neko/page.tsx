      ...
      <div className="wrap">
        <article>
          ...
          <section className="blk">
            ...
            <p>
              捨てられたのではありません。
              <strong>続けられなくなった家がある</strong>、ということになります。
            </p>
            <p>
              <strong>そして、その理由は書けませんでした。</strong>
          ...
          <section className="blk">
            ...
            <p>
              ここまでの数字が、急に違って見えます。
              <strong>あの4割</strong>は、家族を手放さざるを得なかった家の数でした。
