      ...
      <div className="wrap">
        <article>
          ...
          <section className="blk">
            ...
            <p>
              {/* ⚠️ **「手が止まりました」は使わない**（2026-08-02・Satoshiさんの指摘）。
                  `167-children` §「ここを読んで、手が止まりました。」と同じ型で、
                  **2本目で使うと手癖に見える。**ここは前文の「納得しかけました」を
                  受けて打ち消すほうが、借りてきた言い回しより短く効く。 */}
              でも、表の作りを読んで、納得を取り消しました。
            ...
            <p>
              ...
              {/* 🔴 「＝住んでいる場所」と書かない（2026-08-01・Satoshiさんの判断で修正）。
                  この表が数えているのは**卒業した公立小学校の所在地**であって住所ではない。
                  学校選択制や越境通学があれば一致しない。表の注にも住所の記載はない。
                  **「つまり」で等号にしていたのは、この記事がいちばん戒めている踏み込みだった。** */}
              こちらは<strong>通っていた小学校の場所</strong>で並んでいます。
              学校のある場所ではなく、その子が暮らしている地域に近い数え方です。
            </p>
            <p>
            ...
            <div className="note rv">
              ...
              <p>
                ...
                ただ<b>問いが違います。</b>
                自分の家の話をしたいときに近いのは、通っていた小学校で数えたほうでした。
              </p>
            </div>
          </section>
          ...
          <p className="disclaimer">
            ...
            進学した先を数えたものです（本文05）。
            <br />※ 都教委の表が数えているのは、
            <b>卒業した公立小学校の所在地</b>です。学校選択制や越境通学があるため、
            住んでいる場所と完全に一致するわけではありません。表の注にも住所の記載はありません。
