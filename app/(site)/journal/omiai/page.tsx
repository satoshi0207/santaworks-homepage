      ...
      <div className="wrap">
        <article>
          ...
          <section className="blk">
            ...
            <p>
              {/* ⚠️ 「60年前に恋愛結婚を見ていた目つき」と書かない
                  （Satoshiさん・2026-08-06 に言い換え）。
                  **当時の人が恋愛結婚をどう見ていたかを、この記事は数えていない。**
                  出生動向基本調査が聞いているのは*きっかけ*だけで、
                  *どう思われていたか*は載っていない。「目つき」には
                  **冷ややかに見ていた**という含みもあり、当時の人を悪く描いてしまう。 */}
              <strong>
                60年前にも、同じように分けていた人がいたのかもしれません。
              </strong>
              もっとも、これは私の想像です。
