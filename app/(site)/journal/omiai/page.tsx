      ...
      <div className="wrap">
        <article>
          ...
          <section className="blk">
            ...
            <p>
              引っかかったということは、
              <strong>自分の中にも同じ線があった</strong>ということです。
              相談所のほうが少しかたい、というような感じ。
              <b>その感じが何を根拠にしているのか、私は説明できません。</b>
            </p>
            <p>
              <strong>
                60年前に恋愛結婚を見ていた目つきと、そう遠くないのかもしれません。
              </strong>
              もっとも、これは私の想像です。
              <b>数字がそう言っているわけではありません。</b>
            </p>
          </section>
